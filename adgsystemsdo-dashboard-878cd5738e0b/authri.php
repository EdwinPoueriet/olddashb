...
$header = new Header;
$header->Initialize(0, "Autorización de reimpresión recibos");
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="clearfix">
                    <h1 class="pull-left">Autorizar reimpresión de recibos</h1>
                                            ...
                                            <form action="" id="form" method="POST">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    if (isset($_POST['receivable']) &&  isset($_POST['user']) ){
                                                        $general_functions->UserPermission($_POST['user'],$_POST['receivable'],'RI');
                                                    }
                                                    ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <table class="table user-list footable" data-paging-size="12" data-paging-position="right" data-paging="true" data-filtering="true" data-sorting="true">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $general_functions->ReceivablePermissionTable()
                                                    ?>
                                                    </tbody>
                                                </table>
