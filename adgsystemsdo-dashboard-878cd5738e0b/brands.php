...
*/
    ...
    if($credentials[0]->registers_brands == 0)
		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active"><span>Marcas</span></li>
					</ol>
					...
					<div class="clearfix">
						...
						<div class="filter-block pull-right">
							<a onclick="createlist();" class="btn btn-primary pull-right">
								<i class="fa fa-plus-circle fa-lg"></i> Agregar marca
							</a>
						</div>
					</div>
	...
	function createlist(){
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
			...
			'<div class="form-group">' +
				...
				'<label for="bank_name" class="control-label col-sm-3">Nombre de la marca:</label>' +

				'<div class="col-md-7 col-sm-7">' +

					'<input class="form-control input-sm" type="text" name="brand_name" id="bank_name" placeholder="Nombre de la marca" maxlength="100" required>' +
