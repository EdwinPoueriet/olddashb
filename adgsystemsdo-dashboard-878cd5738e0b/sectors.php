...
*/
    ...
    if($credentials[0]->registers_sectors == 0)
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Sectores</span></li>
									</ol>
									
									<div class="clearfix">
										<h1 class="pull-left">Sectores</h1>
										
										<div class="filter-block pull-right">
											<a onclick="createlist();" class="btn btn-primary pull-right">
												<i class="fa fa-plus-circle fa-lg"></i> Agregar Sector
											</a>
										</div>
									</div>
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
  			...
  			'<input type="hidden" id="form_id" name="form_id" value="submitcreate">' +
				...
				'<div class="form-group">' +
					...
					'<div class="col-sm-7">' +
	                  ...
	                  '<select class="form-control input-sm" name="city_id" id="city_id"><?php foreach (json_decode($general_functions->GetCities()) as $row)
	                    { echo '<option value="'.$row->city_id.'">'.$row->city_name.'</option>'; }?></select>' +
					'</div>' +
			...
			'<div class="form-group">' +
				...
				'<div class="col-sm-7">' +
					...
					'<input class="form-control input-sm" type="text" name="sector_name" id="sector_name" value="Nombre" maxlength="40" required>' +
