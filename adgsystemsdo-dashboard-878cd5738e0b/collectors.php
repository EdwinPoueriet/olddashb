...
*/
    ...
    if($credentials[0]->registers_collectors == 0)
...
*/
    ...
    include_once('/legacy/ajax/collectors.php');
...
*/
  ...
  $header = new Header;
  $header->Initialize(0, "Cobradores");
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Cobradores</span></li>
									</ol>
									
									<div class="clearfix">
										<h1 class="pull-left">Cobradores</h1>
										
										<div class="filter-block pull-right">
											<a onclick="createlist();" class="btn btn-primary pull-right">
												<i class="fa fa-plus-circle fa-lg"></i> Agregar cobrador
											</a>
										</div>
									</div>
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
			...
			'<div class="form-group">' +
				...
				'<div class="col-sm-7">' +
					...
					'<input class="form-control input-sm" type="text" name="collector_code" id="collector_code" placeholder="000" maxlength="6" required>' +
			...
			'<div class="form-group">' +
				...
				'<div class="col-md-7 col-sm-7">' +
					...
					'<input class="form-control input-sm" type="text" name="brand_name" id="collector_name" placeholder="Nombre del cobrador" maxlength="100" required>' +
