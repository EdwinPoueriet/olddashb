...
<body>
    <div class="cover">
      <img src="http://sdm.adgsystems.do/img/logo.png" alt="">
        <h1>Pagina no Encontrada <small>Error 404</small></h1>
        <p class="lead"><a href="/">Volver al Dashboard </a></p>
    </div>
</body>
</html>
