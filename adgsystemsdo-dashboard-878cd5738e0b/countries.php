...
*/
    ...
    if($credentials[0]->registers_countries == 0)
...
*/
    ...
    include_once('/legacy/ajax/countries.php');
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Países</span></li>
									</ol>
									...
									<div class="clearfix">
										...
										<div class="filter-block pull-right">
											<a onclick="createlist();" class="btn btn-primary pull-right">
												<i class="fa fa-plus-circle fa-lg"></i> Agregar País
											</a>
											<a onclick="countrylist();" class="btn btn-primary pull-right" style="display:none" id="back">
...

	{
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
			...
			'<div class="form-group">' +
				...
				'<label for="country_name" class="control-label col-sm-2">Nombre:</label>' +

				'<div class="col-sm-4">' +

					'<input class="form-control input-sm" type="text" name="country_name" id="country_name" value="Nombre" maxlength="40" required>' +
