...
*/
    ...
    if($credentials[0]->registers_routes == 0)
...
*/
    ...
    include_once('ajax/legacy/routes.php');
					...
					<div class="clearfix">
						...
						<div class="filter-block pull-right">
							<a onclick="createlist();" class="btn btn-primary pull-right">
								<i class="fa fa-plus-circle fa-lg"></i> Agregar ruta
							</a>
						</div>
					</div>
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
			...
			'<div class="form-group">'+
				...
				'<div class="col-sm-7">' +
					...
					'<input class="form-control input-sm" type="text" name="route_code" id="route_code" placeholder="000" required>' +
			...
			'<div class="form-group">' +
				...
				'<div class="col-sm-7">' +
					...
					'<input class="form-control input-sm" type="text" name="route_name" id="route_name" placeholder="Nombre" required maxlength="20">' +
