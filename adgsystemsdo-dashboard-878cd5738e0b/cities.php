...
*/
    ...
    if($credentials[0]->registers_cities == 0)
...
*/
    ...
    include_once('/legacy/ajax/cities.php');
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Ciudades</span></li>
									</ol>
									...
									<div class="clearfix">
										...
										<div class="filter-block pull-right">
											<a onclick="createlist();" class="btn btn-primary pull-right">
												<i class="fa fa-plus-circle fa-lg"></i> Agregar ciudad
											</a>
										</div>
									</div>
	...
	function createlist(){
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
			...
			'<div class="form-group">' +
				...
				'<label for="city_id" class="control-label col-sm-3">Provincia:</label>' +
				...
				'<div class="col-sm-7">' +
                  ...
                  '<?php 
                    ...
                    foreach (json_decode($general_functions->GetProvinces()) as $row){
			...
			'<div class="form-group">' +
				...
				'<label for="bank_name" class="control-label col-sm-3">Nombre de la ciudad:</label>' +

				'<div class="col-md-7 col-sm-7">' +

					'<input class="form-control input-sm" type="text" name="city_name" id="bank_name" placeholder="Nombre de la ciudad" maxlength="40" required>' +
