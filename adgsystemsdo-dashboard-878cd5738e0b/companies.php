...
*/
    ...
    if($credentials[0]->registers_companies == 0)
		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active"><span>Compañías</span></li>
					</ol>
					
					<div class="clearfix">
						<h1 class="pull-left">Compañías</h1>
