...
*/
    ...
    if($credentials[0]->registers_product_types == 0)
...
*/
  ...
  $header = new Header;
  $header->Initialize(0, "Tipos de producto");
		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active"><span>Tipos de producto</span></li>
					</ol>

					<div class="clearfix">
						<h1 class="pull-left">Tipos de producto</h1>

						<div class="filter-block pull-right">
							<a onclick="createlist();" class="btn btn-primary pull-right">
								<i class="fa fa-plus-circle fa-lg"></i> Agregar tipo de producto
							</a>
						</div>
					</div>
...
*/
	...
	function getValues(){
		...
		$.ajax({
			...
			url: 'ajax/legacy/producttypes.php',
...

	{
		...
		'<div class="form-group">' +
			...
			'<div class="col-sm-7">' +
				...
				'<input class="form-control input-sm" type="text" name="product_type_code" id="product_type_code" placeholder="000" required>' +
		...
		'<div class="form-group">' +
			...
			'<div class="col-sm-7">' +
				...
				'<input class="form-control input-sm" type="text" name="product_type_name" id="product_type_name" placeholder="Nombre" maxlength="50" required>' +
