...
*/
    ...
    if($credentials[0]->registers_product_subclassifications == 0)
...
*/
    ...
    include_once('ajax/legacy/subclassifications.php');
...
*/
  ...
  $header = new Header;
  $header->Initialize(0, "Subclasificaciones");
		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active"><span>Subclasificaciones</span></li>
					</ol>

					<div class="clearfix">
						<h1 class="pull-left">Subclasificaciones</h1>

						<div class="filter-block pull-right">
							<a onclick="createlist();" class="btn btn-primary pull-right">
								<i class="fa fa-plus-circle fa-lg"></i> Agregar subclasificación
							</a>
							<a onclick="subclassificationslist();" class="btn btn-primary pull-right" style="display:none" id="back">
				...
				<div class="col-lg-12">
					<div class="main-box no-header clearfix">
						<div class="main-box-body clearfix" id="main-content">
							<div class="table-responsive" id="subclassifications_list">
								<div class="filter-block pull-right">
								...
								<table class="table user-list footable table-hover" data-paging-size="12" data-paging-position="right" data-paging="true" data-filtering="true" data-sorting="true">
									...
									<tbody>
										...
										$subclassificationslist = new Subclassifications;
										$subclassificationslist->GetSubClassificationsList();
...
*/
	...
	<script type="text/javascript" src="js/registers/subclassifications.js"></script>
</body>
</html>