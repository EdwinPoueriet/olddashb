...
if($credentials[0]->authorization_df == 0)
...
$header = new Header;
$header->Initialize(0, "Autorizar reimpresión de facturas depositadas");
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Facturas Depositadas</span></li>
                </ol>

                <div class="clearfix">
                    <h1 class="pull-left">Autorizar Facturas Depositadas</h1>
                                    ...
                                    <div class="tab-pane fade in active" id="tab-crear">
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="" id="form" method="POST">
                                                <input type="hidden" name="df" id="receivable_input" value="">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <?php
                                                    if (isset($_POST['df']) &&  isset($_POST['user']) ){
                                                        $general_functions->UserPermission($_POST['user'],$_POST['df'],'DF');
                                                    }
                                                    ?>
