...
*/
    ...
    if($credentials[0]->registers_banks == 0)
									...
									<div class="clearfix">
										...
										<div class="filter-block pull-right">
											<a onclick="createlist();" class="btn btn-primary pull-right">
												<i class="fa fa-plus-circle fa-lg"></i> Agregar banco
											</a>
										</div>
									</div>
	...
	function createlist(){
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
			...
			'<div class="col-md-7 col-sm-7">' +
				...
				'<input class="form-control input-sm" type="text" name="bank_code" id="bank_code" placeholder="000" maxlength="3" required>' +
		...
		'<div class="form-group">' +
			...
			'<div class="col-md-7 col-sm-7">' +
				...
				'<input class="form-control input-sm" type="text" name="bank_name" id="bank_name" placeholder="Nombre del banco" maxlength="100" required>' +
