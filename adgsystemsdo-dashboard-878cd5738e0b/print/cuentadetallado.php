...
<!--        </div>-->
    ...
    <div class="row" style="margin-top: 18px">
        <div class="col-sm-12" style="padding: 31px">
     ...
     <table class=\"table table-compact \">
            ...
            if ($_POST['company'] == 'consolidado') {
                if ($_POST['consolidado_group'] == 'consolidado') {
                    printHeader();
                    foreach (json_decode($general->CuentaCobrar($_POST)) as $seller_id => $Sellers){
                        $total = 0;
                        foreach ($Sellers as $Seller) {

                            $total += $Seller->invoice_balance;
                            echo '
                     <tr>
                     <td>'.$Seller->invoice_date.'</td>
                     <td>'.$Seller->invoice_expiration_date.'</td>
                     <td>'.$Seller->seller_code.' - '.$Seller->seller_name.'</td>
                     <td>'.$Seller->customer_name.'</td>
                     <td>'.$Seller->invoice_code.'</td>
                     <td style=\'text-align:right\'>'.convertNumber($Seller->invoice_balance).'</td>
                   </tr>
                   ...
                   ';
                    ...
                    foreach (json_decode($general->CuentaCobrar($_POST)) as $company => $Sellers){
                        ///Company
                        printHeader();
                        ?>
