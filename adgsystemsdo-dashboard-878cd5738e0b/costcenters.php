...
*/
    ...
    if($credentials[0]->registers_costcenters == 0)
...
*/
  ...
  $header = new Header;
  $header->Initialize(0, "Centros de Costo");
						...
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<ol class="breadcrumb">
										<li><a href="#">Home</a></li>
										<li class="active"><span>Centros de Costo</span></li>
									</ol>
									
									<div class="clearfix">
										<h1 class="pull-left">Centros de Costo</h1>
										
										<div class="filter-block pull-right">
											<a onclick="createlist();" class="btn btn-primary pull-right">
												<i class="fa fa-plus-circle fa-lg"></i> Agregar Centro de Costo
											</a>
										</div>
									</div>
		...
		$('#a_modal .modal-content').html('<form id="createform" class="form-horizontal col-md-offset-3 vert-offset-top-2" method="POST" onsubmit="event.preventDefault();">' +
			...
			'<div class="form-group">' +
				...
				'<div class="col-sm-7">' +
					...
					'<input class="form-control input-sm" type="text" name="cost_center_code" id="cost_center_code" placeholder="0000" maxlength="4" required>' +
			...
			'<div class="form-group">' +
				...
				'<div class="col-sm-7">' +
					...
					'<input class="form-control input-sm" type="text" name="cost_center_name" id="cost_center_name" placeholder="Nombre" maxlength="40" required>' +
